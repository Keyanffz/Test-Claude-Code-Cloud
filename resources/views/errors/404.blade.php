<x-layout title="Not found">
    <section class="container-page flex min-h-[calc(100svh-3.5rem)] flex-col justify-between py-10">
        ...
        <div class="grid-page items-end gap-y-8">
            <h1 class="col-span-12 font-display text-[clamp(8rem,34vw,30rem)] leading-[0.78] tracking-[-0.04em] md:col-span-8" data-split>
                4<em class="text-signal">0</em>4
            </h1>
            <div class="col-span-12 space-y-6 md:col-span-4" data-reveal>
